...
@Component({
  ...
  template: \
    ...
    <div class="page-content">
      <div class="container">
        <h2>Terms of Use <span class="highlight">Solutions</span></h2>
        <p>Our platform usage terms and conditions.</p>
        <div class="placeholder-box">
          <p>Detailed content for Terms of Use is coming soon. Stay tuned!</p>
        </div>
      </div>
    </div>
    <app-cta></app-cta>
