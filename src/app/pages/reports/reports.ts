...
@Component({
  ...
  template: \
    ...
    <div class="page-content">
      <div class="container">
        <h2>Reports <span class="highlight">Solutions</span></h2>
        <p>Comprehensive data insights at your fingertips.</p>
        <div class="placeholder-box">
          <p>Detailed content for Reports is coming soon. Stay tuned!</p>
        </div>
      </div>
    </div>
    <app-cta></app-cta>
