      ...
      <div class="container">
        <div class="content-grid">
          <div class="text-content">
            ...
            <p>Ensure a safe and efficient commute for your students with our comprehensive fleet management and real-time tracking system.</p>
            <ul class="feature-list">
              <li><span class="material-icon">check_circle</span> Route & Vehicle Allocation</li>
              <li><span class="material-icon">check_circle</span> Live GPS Tracking for Parents</li>
              <li><span class="material-icon">check_circle</span> Pickup & Drop SMS Alerts</li>
              <li><span class="material-icon">check_circle</span> Vehicle Maintenance & Fuel Tracking</li>
              <li><span class="material-icon">check_circle</span> Driver Profile & Documents Management</li>
            </ul>
          </div>
