        ...
        <div class="content-grid">
          <div class="image-content">
            <div class="placeholder-img">
              <span class="material-icon">how_to_reg</span>
            </div>
          </div>
          <div class="text-content">
            <h2>Effortless <span class="highlight">Attendance Tracking</span></h2>
            <p>Go beyond roll calls with our smart attendance solutions. Integrated with mobile apps and biometric devices, tracking presence has never been easier.</p>
            <ul class="feature-list">
              <li><span class="material-icon">check_circle</span> App-based & Biometric/RFID Integration</li>
              <li><span class="material-icon">check_circle</span> Real-time Absence SMS for Parents</li>
              <li><span class="material-icon">check_circle</span> Subject-wise & Daily Attendance Tracking</li>
              <li><span class="material-icon">check_circle</span> Automated Leave Management</li>
              <li><span class="material-icon">check_circle</span> Comprehensive Attendance Analytics</li>
            </ul>
          </div>
        </div>
      </div>
