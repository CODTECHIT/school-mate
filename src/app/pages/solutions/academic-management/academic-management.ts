      ...
      <div class="container">
        <div class="content-grid">
          <div class="text-content">
            ...
            <p>Our Academic Management system is designed to handle all educational processes efficiently. From curriculum planning to class scheduling, we provide the tools needed for academic excellence.</p>
            <ul class="feature-list">
              <li><span class="material-icon">check_circle</span> Curriculum & Syllabus Planning</li>
              <li><span class="material-icon">check_circle</span> Timetable Management</li>
              <li><span class="material-icon">check_circle</span> Lesson Planning & Tracking</li>
              <li><span class="material-icon">check_circle</span> Academic Calendar Management</li>
            </ul>
          </div>
