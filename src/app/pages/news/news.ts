...
@Component({
  ...
  template: \
    ...
    <div class="page-content">
      <div class="container">
        <h2>In The News <span class="highlight">Solutions</span></h2>
        <p>Latest updates and media coverage of SchoolMate.</p>
        <div class="placeholder-box">
          <p>Detailed content for In The News is coming soon. Stay tuned!</p>
        </div>
      </div>
    </div>
    <app-cta></app-cta>
