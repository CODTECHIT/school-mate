...
@Component({
  ...
  template: \
    ...
    <div class="page-content">
      <div class="container">
        <h2>Our Free Apps <span class="highlight">Solutions</span></h2>
        <p>Download our mobile apps for every stakeholder.</p>
        <div class="placeholder-box">
          <p>Detailed content for Our Free Apps is coming soon. Stay tuned!</p>
        </div>
      </div>
    </div>
    <app-cta></app-cta>
