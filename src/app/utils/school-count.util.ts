export class SchoolCountUtil {
  ...
  static getAllStats(): { label: string; value: number; suffix: string; icon: string }[] {
    return [
      {
        label: 'Schools Trusted Us',
        value: SchoolCountUtil.getSchoolCount(),
        suffix: '+',
        icon: 'school',
      },
      {
        label: 'Happy Students',
        value: SchoolCountUtil.getStudentCount(),
        suffix: '+',
        icon: 'groups',
      },
      {
        label: 'Expert Teachers',
        value: SchoolCountUtil.getTeacherCount(),
        suffix: '+',
        icon: 'person',
      },
      {
        label: 'Client Retention',
        value: SchoolCountUtil.getClientRetention(),
        suffix: '%',
        icon: 'trending_up',
      },
    ];
