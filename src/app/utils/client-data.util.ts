...
export class ClientDataUtil {
  private static clientLogos: ClientLogo[] = [
    ...
    {
      name: 'Santhinikethan',
      imageUrl: 'clients/santhinikethan.png',
      description: 'Santhinikethan School',
    },
  ...
  private static testimonials: Testimonial[] = [
    {
      ...
      school: 'NPDC School',
      quote:
        'schoolmate has completely transformed how we manage our school operations. From attendance to fee management, everything is now streamlined and efficient.',
    },
    {
      name: 'Director',
      role: 'Management',
      ...
      quote:
        'The best school management software we have ever used. The support team is exceptional and the features are comprehensive.',
    },
    {
      name: 'Administrator',
      role: 'School Admin',
      ...
      quote:
        "schoolmate makes school administration effortless. The mobile app keeps parents connected and informed about their children's progress.",
    },
    {
      name: 'Principal',
      role: 'School Head',
      ...
      quote:
        'We switched to schoolmate and saw immediate improvements in our daily operations. Highly recommend it to all educational institutions.',
    },
  ];
